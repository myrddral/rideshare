  ...
  return (
    <>
      ...
      <Form
        ...
        onFinish={onFinish}
      >
        <Form.Item style={{display: "block"}} name="date-picker" label="" {...config}>
          <Calendar fullscreen={false} onPanelChange={onPanelChange} style={{width: "100%", maxWidth: 300}}/>
        </Form.Item>
        <Form.Item style={{display: "block"}} name="time-picker" label="" {...config}>
